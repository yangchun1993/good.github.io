 ...
 *
 * */
$appId = '119495';  // 站点的APPID （请勿修改和泄漏）
$appKey = '5947BAFA742DA7C7BC894C664A353DD2';// 站点的APP KEY（请勿修改和泄漏）
$proxyVersion = 8;
//===============================================================================
//===============================================================================
//===============================================================================
...
if (!defined("IS_UPGRADE_SELF")) {
    define("IS_UPGRADE_SELF", true);
}
...
class HttpHelperes
{
    ...
    protected $upgradeUrl = "http://www.qingtaoke.com/index.php?r=Cms/Upgrade";
